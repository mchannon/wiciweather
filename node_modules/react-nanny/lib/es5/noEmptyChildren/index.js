...
exports.noEmptyChildrenDeep = void 0;
 ...
 */
var noEmptyChildrenDeep = function (component, _a) {
    var _b;
    ...
    if (ignore.indexOf(typeOfComponent_1.typeOfComponent(component)) >= 0)
        return true;
    if (Array.isArray(component)) {
        for (var _i = 0, component_1 = component; _i < component_1.length; _i++) {
            var item = component_1[_i];
            if (exports.noEmptyChildrenDeep(item, { ignore: ignore, rejectCustom: rejectCustom, rejectEmptyCustom: rejectEmptyCustom })) {
                return true;
            }
        }
        return false;
    ...
    if ((typeof component.type === 'string' || (typeOfComponent_1.typeOfComponent(component) === 'react.fragment')) && component.props.children) {
        return exports.noEmptyChildrenDeep(component.props.children, { ignore: ignore, rejectCustom: rejectCustom, rejectEmptyCustom: rejectEmptyCustom });
    }
    else if (typeof component.type === 'string' || typeOfComponent_1.typeOfComponent(component) === 'react.fragment') {
        return false;
    }
...
exports.noEmptyChildrenDeep = noEmptyChildrenDeep;
